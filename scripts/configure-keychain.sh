...
openssl aes-256-cbc -k "$SECURITY_PASSWORD" -in resources/mac_development.cer.enc -d -a -out resources/mac_development.cer
...
security import resources/mac_development.cer -k macos-build.keychain -A
