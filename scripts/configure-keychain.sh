...
openssl aes-256-cbc -k "$SECURITY_PASSWORD" -in resources/mac_developer.p12.enc -d -a -out resources/mac_developer.p12
...
security import resources/mac_developer.p12 -k macos-build.keychain -P $SECURITY_PASSWORD -A
